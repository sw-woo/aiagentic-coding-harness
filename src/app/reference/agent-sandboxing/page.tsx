...
const COMPARISON_ROWS: Row[] = [
  {
    ...
    isolation: "Firecracker microVM (ephemeral VM)",
    startup: "~30초 (cold) · sub-second (snapshot)",
    language: "Amazon Linux 기반 모든 언어 · 브라우저 · Chromium",
    cost: "Vercel 요금제 기준 · 초 단위 VM time",
    whenToUse: "브라우저 자동화, 에이전트 실행 환경, AI 생성 코드 격리 테스트",
  },
  {
    solution: "isolated-vm",
    isolation: "V8 isolate (in-process heap)",
    startup: "ms 단위 (같은 Node.js 프로세스 내)",
  ...
  },
  {
    ...
    isolation: "user-space kernel + seccomp + ptrace",
    startup: "초 단위 (Docker 수준)",
    language: "모든 언어",
    cost: "오픈소스, Google Cloud Run / GKE 지원",
    whenToUse: "컨테이너보다 강한 격리가 필요할 때 · 신뢰할 수 없는 코드 실행",
  },
  {
    solution: "E2B",
    isolation: "Firecracker microVM + 전용 SDK",
    startup: "수백 ms (pre-warmed)",
    language: "Python, TypeScript 중심 · 코드 인터프리터 특화",
    cost: "SaaS 요금제",
